...
export const DeckItem = ({ className, children, ...props }: DeckItemProps) => (
  <div
    className={cn(
      "relative h-full w-full flex items-center justify-center rounded-lg border bg-card text-card-foreground shadow-lg overflow-hidden",
      className,
    )}
    {...props}
  >
